...
<head>
    ...
    <script src="https://canvasjs.com/assets/script/canvasjs.min.js"></script><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    <!-- jQuery library -->
...
<div class="w3-sidebar w3-black w3-bar-block" style="width:15%">
    ...
    <div class="w3-sidebar w3-bar-block w3-black" style="width: 15%">
        ...
        <div id="refresh"><a href="vs2.php"><i class="fa fa-refresh w3-xxxlarge center-block"></i></a></div>
    </div>
</div>
                                        ...
                                        stripLines:[
                                            {
                                                ...
                                                lineDashType: "dot",
                                                label: "Cel: <?php echo json_encode($excel_result12, JSON_NUMERIC_CHECK); ?>",
                                                showOnTop: false,
                                                thickness: 5,
                                                labelPlacement: "outside"
                                            }
