...
<div class="w3-sidebar w3-black w3-bar-block" style="width:15%">
    ...
    <div class="w3-sidebar w3-bar-block w3-black" style="width: 15%">
        <div><a href="vs1.php" class="w3-bar-item w3-button w3-blue w3-left-align w3-center w3-xlarge">VS1</a>
        </div>
        ...
        <div id="naglowki"><h1 id="topTitle" style="text-align: center">Key Performance Indicators Parker Hannifin
            ...
            <div class="charts">
                ...
                <div id="chartContainer" style="height: 300px;width: 100%;">
                    <div class="counter" style="text-align:center"><h3>Dni bez wypadku: </h3>
                        <h1 id="demo"></h1>
                        <form>
                            <label for="password"><input type="password" placeholder="Password" name="password" size="12" id="password"
                                                         onkeyup="activateBtn()"/></label>
